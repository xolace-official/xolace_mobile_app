...
export const dummyPosts: EnhancedPost[] = [
  {
    ...
    posttags: [{ name: "mentalhealth" }, { name: "therapy" }, { name: "growth" }],
    comments_count: 23,
    upvotes: 156,
    downvotes: 3,
    views_count: 892,
  ...
  },
  {
    ...
    post_slides: undefined,
    prompt_text: null,
    posttags: [{ name: "anxiety" }, { name: "support" }, { name: "helpneeded" }],
    comments_count: 47,
    upvotes: 89,
    downvotes: 1,
    views_count: 534,
  ...
  },
  {
    ...
    prompt_text: null,
    posttags: [{ name: "morningroutine" }, { name: "selfcare" }, { name: "habits" }],
    comments_count: 31,
    upvotes: 203,
    downvotes: 7,
    views_count: 1245,
  ...
  },
  {
    ...
    post_slides: undefined,
    prompt_text: null,
    posttags: [{ name: "campfire" }, { name: "community" }, { name: "checkin" }],
    comments_count: 67,
    upvotes: 124,
    downvotes: 0,
    views_count: 678,
  ...
  },
  {
    ...
    posttags: [{ name: "dissociation" }, { name: "mentalhealth" }, { name: "seeking" }],
    comments_count: 42,
    upvotes: 98,
    downvotes: 3,
    views_count: 623,
